...
import { getFieldLabel, matchInt } from "@/utils/contractfunctions";
...
const ContractFunctionSimpleInputField: FC<Props> = ({
    data,
    hideLabel,
    path: name,
    className,
...
export default ContractFunctionSimpleInputField;
