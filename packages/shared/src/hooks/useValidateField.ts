import { BYTES_REGEXP } from "@/utils/contractfunctions";
import type { MatchInt } from "@/utils/contractfunctions";
...
export function useValidateField({ isOptional, argType, argTypeMatchInt }: Params) {
