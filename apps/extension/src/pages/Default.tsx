...
export default function Default({ hasApiKeys, goToSetting }: { hasApiKeys: boolean; goToSetting: () => void }) {
    return (
        <div className="w-full">
            <div className="p-4 space-y-2 flex-1">
                ...
                >
                    ...
                    <span>API Keys {!hasApiKeys && <span className="text-red-500 text-xs">(Required)</span>}</span>
                </button>
